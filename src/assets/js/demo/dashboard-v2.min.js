    ...
    handleScheduleCalendar = function () {
        var t = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
            ...
            a = [
                ...
                ["5/" + n + "/" + o, "Tooltip with link", "https://www.seantheme.com/", COLOR_BLACK],
                ["18/" + n + "/" + o, "Popover with HTML Content", "#", COLOR_BLACK, 'Some contents here <div class="text-right"><a href="https://www.google.com">view more >>></a></div>'],
                ["28/" + n + "/" + o, "Color Admin V1.3 Launched", "https://www.seantheme.com/color-admin-v1.3", COLOR_BLACK]
            ],
            i = $("#schedule-calendar");
        $(i).calendar({
            months: t,
